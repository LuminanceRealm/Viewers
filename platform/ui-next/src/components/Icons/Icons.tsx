...
export const Icons = {
  ...
  'tool-print': (props: IconProps) => ToolPrint(props),
  'tool-print-series': (props: IconProps) => ToolPrintSeries(props),
  ...
  'tool-vertebral-count': (props: IconProps) => ToolVertebralCount(props),
  'tool-cardiothoracic-index': (props: IconProps) => ToolCardiothoracicIndex(props),
  'tool-calcium-score': (props: IconProps) => ToolCalciumScore(props),
  'tool-coronary-cpr': (props: IconProps) => ToolCoronaryCpr(props),
  'tool-breast-kinetics': (props: IconProps) => ToolBreastKinetics(props),
